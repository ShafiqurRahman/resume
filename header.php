...
<header class="header">
    <div class="top-header">
        ...
        <h2 class="h2 text-center">Resume of <?= $resume['name']; ?></h2>
        <i class="phone"> 
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark  p-2 mb-5 shadow_custom">
        <div class="collapse navbar-collapse  justify-content-center" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link <?= $class_name; ?>" href="home.php">Home</a>
